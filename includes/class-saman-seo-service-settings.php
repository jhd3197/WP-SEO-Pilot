...
class Settings {
	...
	public function register_settings() {
		...
		register_setting( 'saman-seo', 'SAMAN_SEO_default_title_template', [ $this, 'sanitize_template' ] );

		// Consolidated Search Appearance Settings
		$group = 'SAMAN_SEO_search_appearance';
		register_setting( $group, 'SAMAN_SEO_post_type_title_templates', [ $this, 'sanitize_post_type_templates' ] );
		register_setting( $group, 'SAMAN_SEO_post_type_meta_descriptions', [ $this, 'sanitize_post_type_descriptions' ] );
		register_setting( $group, 'SAMAN_SEO_post_type_keywords', [ $this, 'sanitize_post_type_keywords' ] );
		register_setting( $group, 'SAMAN_SEO_post_type_settings', [ $this, 'sanitize_post_type_settings' ] );
		register_setting( $group, 'SAMAN_SEO_taxonomy_settings', [ $this, 'sanitize_taxonomy_settings' ] );
		register_setting( $group, 'SAMAN_SEO_archive_settings', [ $this, 'sanitize_archive_settings' ] );
		...
		register_setting( $group, 'SAMAN_SEO_title_separator', [ $this, 'sanitize_separator' ] );

		// New consolidated options for Search Appearance page redesign
		register_setting( $group, 'SAMAN_SEO_homepage_defaults', [ $this, 'sanitize_homepage_defaults' ] );
		register_setting( $group, 'SAMAN_SEO_post_type_defaults', [ $this, 'sanitize_post_type_defaults' ] );
		register_setting( $group, 'SAMAN_SEO_taxonomy_defaults', [ $this, 'sanitize_taxonomy_defaults' ] );
		register_setting( $group, 'SAMAN_SEO_archive_defaults', [ $this, 'sanitize_archive_defaults_new' ] );

		// Social settings (also registered under search_appearance group)
		register_setting( $group, 'SAMAN_SEO_social_defaults', [ $this, 'sanitize_social_defaults' ] );
		...
		register_setting( 'SAMAN_SEO_social', 'SAMAN_SEO_post_type_social_defaults', [ $this, 'sanitize_post_type_social_defaults' ] );
		...
		register_setting( 'saman-seo', 'SAMAN_SEO_default_noindex', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_default_nofollow', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_global_robots', 'sanitize_text_field' );
		register_setting( 'saman-seo', 'SAMAN_SEO_hreflang_map', [ $this, 'sanitize_json' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_robots_txt', 'sanitize_textarea_field' );
		// Legacy enable_* options - @deprecated Use SAMAN_SEO_module_* options instead.
		register_setting( 'saman-seo', 'SAMAN_SEO_enable_sitemap_enhancer', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_enable_redirect_manager', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_enable_404_logging', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_enable_og_preview', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_enable_llm_txt', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_enable_local_seo', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_enable_analytics', [ $this, 'sanitize_bool' ] );

		// New module toggle options (used by React UI).
		register_setting( 'saman-seo', 'SAMAN_SEO_module_sitemap', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_module_redirects', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_module_404_log', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_module_llm_txt', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_module_local_seo', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_module_social_cards', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_module_analytics', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_module_admin_bar', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_module_internal_links', [ $this, 'sanitize_bool' ] );
		register_setting( 'saman-seo', 'SAMAN_SEO_module_ai_assistant', [ $this, 'sanitize_bool' ] );
	}
	...
	public function get_context_variables() {
		$variables = [
			'global' => [
				...
				'vars'  => [
					[ 'tag' => 'site_title', 'label' => __( 'Site Title', 'saman-seo' ), 'desc' => __( 'The main title of your site', 'saman-seo' ), 'preview' => get_bloginfo( 'name' ) ],
					[ 'tag' => 'tagline', 'label' => __( 'Tagline', 'saman-seo' ), 'desc' => __( 'Site description / tagline', 'saman-seo' ), 'preview' => get_bloginfo( 'description' ) ],
					[ 'tag' => 'separator', 'label' => __( 'Separator', 'saman-seo' ), 'desc' => __( 'Separator character (e.g. -)', 'saman-seo' ), 'preview' => $this->get( 'SAMAN_SEO_title_separator' ) ],
					[ 'tag' => 'current_year', 'label' => __( 'Current Year', 'saman-seo' ), 'desc' => __( 'The current year (4 digits)', 'saman-seo' ), 'preview' => date_i18n( 'Y' ) ],
				],
			],
			'post' => [
				'label' => __( 'Post Variables', 'saman-seo' ),
				'vars'  => [
					[ 'tag' => 'post_title', 'label' => __( 'Post Title', 'saman-seo' ), 'desc' => __( 'Title of the current post/page', 'saman-seo' ), 'preview' => 'Hello World' ],
					[ 'tag' => 'post_excerpt', 'label' => __( 'Excerpt', 'saman-seo' ), 'desc' => __( 'Post excerpt or auto-generated snippet', 'saman-seo' ), 'preview' => 'This is an example excerpt...' ],
					[ 'tag' => 'post_date', 'label' => __( 'Date', 'saman-seo' ), 'desc' => __( 'Publish date', 'saman-seo' ), 'preview' => date_i18n( get_option( 'date_format' ) ) ],
					[ 'tag' => 'post_author', 'label' => __( 'Author', 'saman-seo' ), 'desc' => __( 'Display name of the author', 'saman-seo' ), 'preview' => 'John Doe' ],
					[ 'tag' => 'category', 'label' => __( 'Primary Category', 'saman-seo' ), 'desc' => __( 'The main category for this post', 'saman-seo' ), 'preview' => 'Technology' ],
					[ 'tag' => 'modified', 'label' => __( 'Modified Date', 'saman-seo' ), 'desc' => __( 'Last modified date', 'saman-seo' ), 'preview' => date_i18n( get_option( 'date_format' ) ) ],
					[ 'tag' => 'id', 'label' => __( 'ID', 'saman-seo' ), 'desc' => __( 'The numeric post ID', 'saman-seo' ), 'preview' => '123' ],
				],
			],
			'taxonomy' => [
				'label' => __( 'Taxonomy Variables', 'saman-seo' ),
				'vars'  => [
					[ 'tag' => 'term_title', 'label' => __( 'Term Name', 'saman-seo' ), 'desc' => __( 'Name of the current category/tag', 'saman-seo' ), 'preview' => 'My Category' ],
					[ 'tag' => 'term_description', 'label' => __( 'Term Description', 'saman-seo' ), 'desc' => __( 'Description of the term', 'saman-seo' ), 'preview' => 'A list of all posts about...' ],
				],
			],
			'archive' => [
				'label' => __( 'Archive Variables', 'saman-seo' ),
				'vars'  => [
					[ 'tag' => 'archive_title', 'label' => __( 'Archive Title', 'saman-seo' ), 'desc' => __( 'Title based on date or type', 'saman-seo' ), 'preview' => 'Archives for June 2025' ],
					[ 'tag' => 'archive_date', 'label' => __( 'Archive Date', 'saman-seo' ), 'desc' => __( 'Date for daily/monthly archives', 'saman-seo' ), 'preview' => 'June 2025' ],
				],
			],
			'author' => [
				'label' => __( 'Author Variables', 'saman-seo' ),
				'vars'  => [
					[ 'tag' => 'author_name', 'label' => __( 'Author Name', 'saman-seo' ), 'desc' => __( 'Name of the author being viewed', 'saman-seo' ), 'preview' => 'Jane Smith' ],
					[ 'tag' => 'author_bio', 'label' => __( 'Author Bio', 'saman-seo' ), 'desc' => __( 'Biographical info', 'saman-seo' ), 'preview' => 'Jane is a writer...' ],
				],
			],
		];
	...
	public function register_menu() {
		...
		add_submenu_page(
			'saman-seo',
			__( 'Search Appearance', 'saman-seo' ),
			__( 'Search Appearance', 'saman-seo' ),
			'manage_options',
			'saman-seo-types',
	...
	public function render_settings_page() {
		...
		wp_localize_script(
			...
			'SamanSEOAdmin',
			[
				'mediaTitle'  => __( 'Select default image', 'saman-seo' ),
		...
		include SAMAN_SEO_PATH . 'templates/settings-page.php';
	}
	...
	public function render_post_type_defaults_page() {
		...
		$post_type_defaults = get_option( 'SAMAN_SEO_post_type_defaults', [] );
		if ( ! is_array( $post_type_defaults ) ) {
			$post_type_defaults = [];
		}

		// Prepare taxonomy defaults
		$taxonomy_defaults = get_option( 'SAMAN_SEO_taxonomy_defaults', [] );
		...
		include SAMAN_SEO_PATH . 'templates/search-appearance.php';
	}
}
