...
class Local_SEO {
	...
	public function get_business_types() {
		return [
			'LocalBusiness'       => __( 'Local Business (Generic)', 'saman-labs-seo' ),
			'Restaurant'          => __( 'Restaurant', 'saman-labs-seo' ),
			'Dentist'             => __( 'Dentist', 'saman-labs-seo' ),
			'Physician'           => __( 'Physician', 'saman-labs-seo' ),
			'MedicalClinic'       => __( 'Medical Clinic', 'saman-labs-seo' ),
			'Attorney'            => __( 'Attorney', 'saman-labs-seo' ),
			'RealEstateAgent'     => __( 'Real Estate Agent', 'saman-labs-seo' ),
			'Store'               => __( 'Store', 'saman-labs-seo' ),
			'AutoDealer'          => __( 'Auto Dealer', 'saman-labs-seo' ),
			'HairSalon'           => __( 'Hair Salon', 'saman-labs-seo' ),
			'BeautySalon'         => __( 'Beauty Salon', 'saman-labs-seo' ),
			'Plumber'             => __( 'Plumber', 'saman-labs-seo' ),
			'Electrician'         => __( 'Electrician', 'saman-labs-seo' ),
			'Locksmith'           => __( 'Locksmith', 'saman-labs-seo' ),
			'AccountingService'   => __( 'Accounting Service', 'saman-labs-seo' ),
			'FinancialService'    => __( 'Financial Service', 'saman-labs-seo' ),
			'InsuranceAgency'     => __( 'Insurance Agency', 'saman-labs-seo' ),
			'TravelAgency'        => __( 'Travel Agency', 'saman-labs-seo' ),
			'AutomotiveBusiness'  => __( 'Automotive Business', 'saman-labs-seo' ),
			'FoodEstablishment'   => __( 'Food Establishment', 'saman-labs-seo' ),
			'EntertainmentBusiness' => __( 'Entertainment Business', 'saman-labs-seo' ),
			'LodgingBusiness'     => __( 'Lodging Business', 'saman-labs-seo' ),
			'SportsActivityLocation' => __( 'Sports Activity Location', 'saman-labs-seo' ),
		];
	}
